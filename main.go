...
import (
	...
	infrastructurev1alpha1 "github.com/setoru/cluster-api-provider-docker/api/v1alpha1"
	"github.com/setoru/cluster-api-provider-docker/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4136ee37.cluster.x-k8s.io",
